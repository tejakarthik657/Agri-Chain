...
import NotificationItem from "../../components/logistic/Notifications/NotificationItem";
import NotificationFilter from "../../components/logistic/Notifications/NotificationFilter";
import NotificationSort from "../../components/logistic/Notifications/NotificationSort";
import NotificationActions from "../../components/logistic/Notifications/NotificationActions";
import NotificationPagination from "../../components/logistic/Notifications/NotificationPagination";
...
export default function LogisticsNotifications({ onUnreadCountChange }: { onUnreadCountChange?: (count: number) => void }) {
  ...
  // Reset page if filter/sort changes
  useEffect(() => {
